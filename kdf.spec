...
Version  : 24.05.0
Release  : 67
URL      : https://download.kde.org/stable/release-service/24.05.0/src/kdf-24.05.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.05.0/src/kdf-24.05.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.0/src/kdf-24.05.0.tar.xz.sig
...
%setup -q -n kdf-24.05.0
cd %{_builddir}/kdf-24.05.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716575690
mkdir -p clr-build
pushd clr-build

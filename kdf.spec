...
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kdf-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kdf-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kdf-22.12.3
cd %{_builddir}/kdf-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677795144
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdfprivate.so.22.12.3

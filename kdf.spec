...
Version  : 25.04.0
Release  : 80
URL      : https://download.kde.org/stable/release-service/25.04.0/src/kdf-25.04.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kdf-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kdf-25.04.0.tar.xz.sig
...
%setup -q -n kdf-25.04.0
cd %{_builddir}/kdf-25.04.0
pushd ..
cp -a kdf-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744940091
mkdir -p clr-build
pushd clr-build

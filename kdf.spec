...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kdf-21.12.0.tar.xz
...
%prep
%setup -q -n kdf-21.12.0
cd %{_builddir}/kdf-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639636399
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdf-21.12.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/kdf/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/kdf-21.12.0/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdf/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
%find_lang kdf
...
/usr/lib64/libkdfprivate.so.21.12.0

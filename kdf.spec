...
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/kdf-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/kdf-24.08.0.tar.xz.sig
...
%setup -q -n kdf-24.08.0
cd %{_builddir}/kdf-24.08.0
pushd ..
cp -a kdf-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724647761
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdfprivate.so.24.08.0
/V3/usr/lib64/qt6/plugins/plasma/kcms/systemsettings_qwidgets/kcm_kdf.so
/usr/lib64/libkdfprivate.so.24
/usr/lib64/libkdfprivate.so.24.08.0

...
Version  : 25.04.1
Release  : 81
URL      : https://download.kde.org/stable/release-service/25.04.1/src/kdf-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kdf-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kdf-25.04.1.tar.xz.sig
...
%setup -q -n kdf-25.04.1
cd %{_builddir}/kdf-25.04.1
pushd ..
cp -a kdf-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747164884
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdf-%{version}/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdf/3e8971c6c5f16674958913a94a36b1ea7a00ac46 || :
export GOAMD64=v2
pushd ../buildavx2/
GOAMD64=v3
pushd clr-build-avx2
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdfprivate.so.25.04.1
/V3/usr/lib64/qt6/plugins/plasma/kcms/systemsettings_qwidgets/kcm_kdf.so
/usr/lib64/libkdfprivate.so.25
/usr/lib64/libkdfprivate.so.25.04.1
/usr/lib64/qt6/plugins/plasma/kcms/systemsettings_qwidgets/kcm_kdf.so

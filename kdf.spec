...
Version  : 24.02.0
Release  : 63
URL      : https://download.kde.org/stable/release-service/24.02.0/src/kdf-24.02.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kdf-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kdf-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kdf-24.02.0
cd %{_builddir}/kdf-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710304224
mkdir -p clr-build
pushd clr-build

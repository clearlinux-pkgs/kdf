...
Source0  : https://download.kde.org/stable/release-service/24.05.1/src/kdf-24.05.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.1/src/kdf-24.05.1.tar.xz.sig
...
%setup -q -n kdf-24.05.1
cd %{_builddir}/kdf-24.05.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718416486
mkdir -p clr-build
pushd clr-build

...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/kdf-22.08.0.tar.xz
...
%prep
%setup -q -n kdf-22.08.0
cd %{_builddir}/kdf-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661551883
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdfprivate.so.22.08.0

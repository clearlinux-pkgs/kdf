...
Version  : 19.08.1
Release  : 12
URL      : https://download.kde.org/stable/applications/19.08.1/src/kdf-19.08.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.1/src/kdf-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/kdf-19.08.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567699651
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdfprivate.so.19.08.1
